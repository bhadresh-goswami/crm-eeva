...
const rowClassName = (hours: number) => {
  if (hours >= 8) return 'table-success'
  if (hours >= 5) return 'table-warning'
  return 'table-danger'
}

const DailyWorkingAnalyticsTable = ({ data = { summary: {}, rows: [] }, loading = false }: DailyWorkingAnalyticsTableProps) => {
