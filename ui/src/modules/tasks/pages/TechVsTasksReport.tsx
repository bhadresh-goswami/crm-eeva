...
const TechVsTasksReport = () => {
  ...
  const [selectedStatus, setSelectedStatus] = useState<'completed' | 'success' | 'rejected' | ''>('')
  ...
  const handleOpenTaskDetails = async (expertId: number, expertName: string, status: 'completed' | 'success' | 'rejected') => {
