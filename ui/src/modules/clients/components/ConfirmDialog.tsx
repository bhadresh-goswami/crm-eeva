...
const ConfirmDialog = ({ isOpen, title, message, isLoading = false, onConfirm, onCancel }: ConfirmDialogProps) => {
  ...
  return (
    <div className="modal-overlay" role="presentation" onClick={onCancel}>
      <div className="modal-card" role="dialog" aria-modal="true" aria-labelledby="client-confirm-title" onClick={(event) => event.stopPropagation()}>
        <h3 id="client-confirm-title" className="modal-title">
          {title}
        </h3>
